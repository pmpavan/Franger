 ...
 * @since 4.1
 */
public class FDByteArrayBody extends AbstractContentBody {
     ...
     */
    public FDByteArrayBody(final byte[] data, final String mimeType, final String filename) {
        super(mimeType);
        if (data == null) {
     ...
     * @param filename The name of the file contained in this part.
     */
    public FDByteArrayBody(final byte[] data, final String filename) {
