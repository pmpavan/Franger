...
//    @ActivityScope
//    @Provides
//    ProfileViewModel profilePresenter(@NonNull Context context, @NonNull LoggedInUser user, @NonNull UserStore userStore, @NotNull EventBus eventBus, @NotNull ProfileInteractor profileInteractor) {
//        return new ProfileViewModel(context, user, userStore, eventBus, profileInteractor);
//    }

    @Provides
    @ActivityScope
    ViewModelProvider.Factory profileActivityViewModel(@NonNull Context context, @NonNull LoggedInUser loggedInUser, @NonNull UserStore userStore, @NotNull EventBus eventBus, @NotNull ProfileInteractor profileInteractor) {
        return new ProfileViewModel.Factory(context, loggedInUser, eventBus, userStore, profileInteractor);
    }
}
