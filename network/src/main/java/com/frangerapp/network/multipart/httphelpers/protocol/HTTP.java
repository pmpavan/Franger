...
package com.frangerapp.network.multipart.httphelpers.protocol;


import com.frangerapp.network.multipart.httphelpers.Consts;
...
public final class HTTP {
    ...
    public static final String USER_AGENT = "UserDetail-Agent";
