...
package com.frangerapp.network.multipart.content;


import com.frangerapp.network.multipart.MIME;
 ...
 * @since 4.0
 */
public class FDStringBody extends AbstractContentBody {
     ...
     * @since 4.1
     */
    public static FDStringBody create(
            final String text,
            final String mimeType,
            final Charset charset) throws IllegalArgumentException {
        try {
            return new FDStringBody(text, mimeType, charset);
     ...
     * @since 4.1
     */
    public static FDStringBody create(final String text) throws IllegalArgumentException {
     ...
     * @throws IllegalArgumentException if the {@code text} parameter is null
     */
    public FDStringBody(final String text, final Charset charset) throws UnsupportedEncodingException {
     ...
     * @throws IllegalArgumentException if the {@code text} parameter is null
     */
    public FDStringBody(final String text) throws UnsupportedEncodingException {
