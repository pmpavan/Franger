package com.frangerapp.franger.data.countries;

import android.content.Context;
import android.support.annotation.NonNull;

import com.frangerapp.franger.data.BaseApi;
import com.frangerapp.franger.data.countries.model.CountriesListWrapper;
...
public class CountriesApi extends BaseApi {
    ...
    public CountriesApi(@NonNull Context context, @NonNull HttpClient httpClient, Gson gson) {
    ...
    public Single<List<Country>> getCountriesList() {
        return Single.fromCallable(() -> {
            String countriesJson = "{" +
                    ...
                    "  ]" +
                    "}";
            CountriesListWrapper wrapper = gson.fromJson(countriesJson, CountriesListWrapper.class);
